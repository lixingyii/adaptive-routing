...
def main():
    ...
    parser.add_argument('-fT', dest='time_limit_end', action='store', type=int, default=2050000000, help="only consider flows that finish before T, default=100 * 10^9 ns")
        ...
        for line in f.readlines():
            for topo in topo2bdp.keys():
                if topo in line:
                    ...
                    algorithm = parsed_line[17]
                    impl = parsed_line[18]
                    phy_dims = parsed_line[19]
